...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://wc/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://wc/", "ConvertResponse");
    private static final QName _GetCompte_QNAME = new QName("http://wc/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://wc/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://wc/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://wc/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://wc/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://wc/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wc/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://wc/", name = "getCompteResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://wc/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://wc/", name = "listComptesResponse")
